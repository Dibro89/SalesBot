    ...
    <?php if ($form): ?>
        <form method="get">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="inputSourceUrl" name="sourceUrl" type="text" placeholder="Source URL">
            </div>
            <div class="form-group">
                <label for="inputDiscount">Discount</label>
                <input class="form-control" id="inputDiscount" name="discount" type="number" placeholder="Discount">
            </div>
            <div class="form-group">
                <label for="inputPrice">Price</label>
                <input class="form-control" id="inputPrice" name="price" type="number" placeholder="Price">
            </div>
            <div class="form-group">
                <label for="inputDescFull">Description</label>
                <input class="form-control" id="inputDescFull" name="descFull" type="text" placeholder="Description">
            </div>
            <div class="form-group">
                <label for="inputStarted">Started</label>
                <input class="form-control" id="inputStarted" name="started" type="date" placeholder="Started">
            </div>
            <div class="form-group">
                <label for="inputDuration">Duration</label>
                <input class="form-control" id="inputDuration" name="duration" type="number" placeholder="Duration">
            </div>
            <hr>
            <div class="checkbox">
                <label>
